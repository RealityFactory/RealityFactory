...
#define	QX_PARTICLE_HAS_VELOCITY			 2 //( 1 << 1 )
#define QX_PARTICLE_HAS_GRAVITY				 4 //( 1 << 2 )
#define QX_PARTICLE_ANIMATION				 8 //( 1 << 3 )
#define QX_PARTICLE_ALPHA_FADEIN_FADEOUT	16 //( 1 << 4 )
