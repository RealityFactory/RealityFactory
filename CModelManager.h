...
public:
    ...
    int SetToTargetTime(geWorld_Model *theModel, geFloat TT);
	// end change
	...
	int SetRideable(geWorld_Model *theModel, bool bRideable);
	...
	// changed RF064
	int SetPosition(geWorld_Model *theModel, const geVec3d &thePosition);
	...
	int SetBoundingBox(geWorld_Model *theModel, const geExtBox &theBBox);
